...
class Config:
    def __init__(self):
        ...
        # --- Normal Aim ---
        self.normal_x_speed = 0.75
        self.normal_y_speed = 0.2
        ...
        self.rcs_game = "apex"
        self.rcs_weapon = "jitter"
        self.rcs_intensity = 0.75

        # === Jitter / RCS Settings ===
        self.jitter_enabled = False
        self.jitter_interval = 0.01  # секунды между движениями
        self.hipfire_sens = 1.0  # чувствительность от бедра
        self.ads_sens = 1.0  # чувствительность с прицела
        ...
        self.mouse_lock_y: bool = True             # Блокировать ось Y при аиме
